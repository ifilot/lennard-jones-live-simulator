...
# copy executable
cp -v ../build/release/ljsim.exe packages/com.vendor.product/data

# run windeploy
/c/Qt/6.7.0/mingw_64/bin/windeployqt.exe packages/com.vendor.product/data/ljsim.exe --release --force
...
# run packaging tool
/c/Qt/Tools/QtInstallerFramework/4.8/bin/binarycreator.exe -c config/config.xml -p packages ljsim-installer-win64.exe