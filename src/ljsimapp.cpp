 ...
 */
LJSimApp::LJSimApp(int& argc, char** argv) :
 ...
 * @return
 */
bool LJSimApp::notify(QObject* receiver, QEvent* event) {
    bool done = true;
    try {
...
void LJSimApp::throw_message_window(const QString& title, const QString& message) {
